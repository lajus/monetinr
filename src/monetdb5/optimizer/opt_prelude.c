...
void optimizerInit(void){
	if(batRef == NULL){
		...
		addColumnRef = putName("addColumn", 9);
		...
		leakRef= putName("leak", 4);
		leakerRef= putName("leaker", 6);
		leakValueRef = putName("leakValue", 9);
